...
public class DeleteCommentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean isDeleted = dao.deleteComment(commentId);
            if (isDeleted) {
                TblNotificationDAO notifyDAO = new TblNotificationDAO();
                notifyDAO.deleteCommentNotification(email, articleId, commentId);
            }
            ...
            LOGGER.fatal("DeleteCommentServlet _ Naming: " + ex.getMessage());
        } catch (SQLException ex) {
            LOGGER.fatal("DeleteCommentServlet _ SQL: " + ex.getMessage());
        } finally {
